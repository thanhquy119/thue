...
function articleCount(document: DocumentDetail) {
  return document.provisions.filter((provision) => provision.type === "article").length;
}

function chapterCount(document: DocumentDetail) {
