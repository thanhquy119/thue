...
/**
 * Chia phụ đề theo từng câu độc lập. Cân bằng độ dài chỉ diễn ra giữa các
 * mảnh thuộc cùng một câu, nên phần đầu câu sau không thể bị kéo vào caption
 * trước như trường hợp "... tương ứng. Người nộp thuế".
 */
